...
* 브라우저의 XMLHttpRequest 객체는 무엇이고 어떻게 동작하나요?
    ...
    - 브라우저는 XMLHttpRequest 객체를 이용하여 Ajax 요청을 생성하고, 서버가 브라우저의 요청에 대한 응답을을 전달하면 같은 XMLHttpRequest 객체가 그결과를 처리한다.
    - XMLHttpRequest클래스는 HTTP를 통해 쉽게 데이터를 받기 위해 만들어진 JavaScript객체
